...
<?php 
$bookid=intval($_GET['bookid']);
$sql = "SELECT tbl_bookdetails.BOOK_TITLE,tbl_bookdetails.id as bookid,tbl_bookdetails.BOOK_IMG from  tbl_bookdetails  where tbl_bookdetails.BOOK_ID=:bookid";
$query = $dbh -> prepare($sql);
$query->bindParam(':bookid',$bookid,PDO::PARAM_STR);
$query->execute();
...
<input class="form-control" type="text" name="bookname" value="<?php echo htmlentities($result->BOOK_TITLE);?>" readonly />
</div></div>
